            ...
            <div className="w-[45%] h-full flex flex-col items-center justify-center relative p-12">
                ...
                <div className="relative z-10 text-center flex flex-col items-center">
                    <div className="w-24 h-24 bg-black rounded-full mb-8 flex items-center justify-center shadow-[0_0_40px_rgba(187,252,7,0.4)]">
                        <i className="fa-solid fa-microphone text-5xl text-(--green)"></i>
                    </div>
                    <h1 className="text-6xl font-bold uppercase tracking-tighter text-black mb-4" style={{ fontFamily: 'impact, sans-serif' }}>
                        CREATOR<br />HUB
                    </h1>
                    <p className="text-gray-600 font-medium tracking-wide">
                        Upload your tracks, manage your albums, and connect with your fans.
                    </p>
                </div>
            </div>
            ...
            <div className="w-[55%] h-full flex items-center justify-center relative z-10 p-16">
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-10">
                        <div className="flex items-center justify-between">
                            ...
                            <Link to="/login" className="text-xs text-gray-500 hover:text-white transition-colors">
                                Are you a Listener? <span className="text-(--green) underline underline-offset-2">Go to User Hub</span>
                            </Link>
                        </div>
                        <h2 className="text-4xl font-bold text-white mb-2">
                            {isLogin ? 'Log In to ' : 'Sign Up for '}
                            <span className="text-(--green)">Artists</span>
                        </h2>
                        <p className="text-gray-400 text-sm">
                            {isLogin ? 'Enter your details to access your creator account.' : 'Create an account to share your musical journey.'}
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                        {!isLogin && (
                            <div className="flex flex-col gap-2">
                                <label className="text-xs font-semibold tracking-widest text-gray-400">ARTIST / BAND NAME</label>
                    ...
                    <div className="mt-8 text-center text-sm text-gray-500">
                        {isLogin ? "Don't have an artist account? " : "Already have an artist account? "}
                        <button
